...
export const TIAN_DI_TU = "tian_di_tu";
export const A_MAP = "a_map";
export const BAI_DU = "bai_du";
...
export function defaultInitCesium(
  ...
  if (mapType == ARC_GIS) {
    ...
    imageryProvider = getOfflineImageProvider();
  }
...
// offline
function getOfflineImageProvider() {
